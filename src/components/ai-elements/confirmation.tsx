...
export async function ConfirmationRequest({ children }: ConfirmationRequestProps) {
...
export async function ConfirmationAccepted({
  children,
...
export async function ConfirmationRejected({
  children,
